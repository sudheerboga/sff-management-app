...
// LoadingScreen is used here instead of SplashScreen to ensure a minimum display time and avoid a flash
// <Box
    //   sx={{
    //     minHeight: '100vh',
    //     display: 'flex',
    ...
    //     v1.0.0
    //   </Typography>
    // </Box> of the login/dashboard page if auth state resolves quickly.