...
import { subscribeToOrders, subscribeToMeasurements, addOrder as fbAdd, updateOrder as fbUpdate, deleteOrder as fbDelete, saveMeasurement as fbSave, upsertUserProfile, getUserProfile } from '../firebase/userService';
...
export function useUserData(uid) {
  ...
  return { orders, measurements, profile, loading, addOrder, updateOrder, deleteOrder, saveMeasurement };
}
