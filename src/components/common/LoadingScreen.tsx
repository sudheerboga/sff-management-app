          ...
          <div style={{
            ...
            <img
              ...
              onError={(e) => {
                ...
                if (parent) {
                  parent.style.background = `linear-gradient(135deg, ${BLUE} 0%, ${VIOLET} 40%, ${ROSE} 100%)`;
                  parent.innerHTML = `<span style="font-family:${FONT_DISPLAY};font-size:44px;font-weight:700;color:#fff">B</span>`;
                }
              }}
            />
          </div>
