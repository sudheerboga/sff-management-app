...
export default function AppHeader({ user }) {
  ...
  return (
    <div style={{
      ...
      position:'sticky', top:0, zIndex:40, fontFamily:T.fontBody,
      ...
      <div style={{ display:'flex', alignItems:'center', gap:12 }}>
        ...
        <button onClick={toggle} title={isDark ? 'Switch to Light' : 'Switch to Dark'} style={{
          ...
          borderRadius:T.r.pill, padding:'5px 11px',
        ...
        <div style={{
          ...
          borderRadius:T.r.pill, background:T.success.bg, border:`1px solid ${T.success.border}`,
        }}>
          <div style={{ width:6, height:6, borderRadius:'50%', background:T.success.text,
            boxShadow: isDark ? '0 0 6px rgba(74,222,128,.6)' : 'none',
        ...
        <div style={{ position:'relative' }}>
          <button onClick={() => setMenu(s=>!s)} style={{ border:'none', background:'none', cursor:'pointer', padding:0 }}>
          ...
          {menu && (
            <>
              ...
              <div style={{
                ...
                border:`1px solid ${T.border}`,
                borderRadius:T.r.lg, padding:10, zIndex:50, minWidth:196,
                boxShadow: T.sh.lg,
              }}>
                <div style={{ position:'absolute', top:0, left:'15%', right:'15%', height:1, background:T.grad.brand, opacity:.5 }} />
                <div style={{ padding:'8px 10px 12px', borderBottom:`1px solid ${T.border}`, marginBottom:6 }}>
                ...
                <button onClick={async () => { if(window.confirm('Sign out?')) await logOut(); setMenu(false); }}
