...
export default function AppHeader({ user }) {
  ...
  return (
    <div style={{ background:'rgba(249,245,240,.92)', backdropFilter:'blur(20px)', WebkitBackdropFilter:'blur(20px)', padding:'12px 20px 10px', borderBottom:`1px solid ${T.border}`, position:'sticky', top:0, zIndex:40, fontFamily:T.fontBody }}>
