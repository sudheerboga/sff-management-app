...
export default function SplashScreen() {
  ...
  return (
    <div style={{ minHeight:'100vh', width:'100%', background:T.grad.dark1, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', position:'relative', overflow:'hidden' }}>
      ...
      <div style={{ opacity:p>=1?1:0, transform:p>=1?'translateY(0)':'translateY(12px)', transition:'all .5s cubic-bezier(.4,0,.2,1) .1s', textAlign:'center', marginBottom:10 }}>
        ...
        <div style={{ fontFamily:T.fontDisplay, fontSize:20, fontStyle:'italic', fontWeight:400, background:T.grad.brand, WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', marginTop:2 }}>Fusion</div>
      </div>
