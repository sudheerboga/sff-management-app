  ...
  return (
    <>
      ...
      >
        ...
        <div style={{ position:'absolute', left:0, top:'20%', bottom:'20%', width:1.8, borderRadius:'0 2px 2px 0', background:T.grad.brand, opacity:.7 }} />
          ...
          <div style={{ display:'flex', alignItems:'center', gap:10 }}>
            ...
            <div>
              ...
              <div style={{ fontSize:11, color:T.muted, marginTop:1 }}>
                {order.mobile ? `📱 +91 ${order.mobile}` : order.date}
              </div>
        ...
        {/* Items */}
        <div onClick={()=>onClick(order)} style={{ fontSize:13, color:T.text2, lineHeight:1.65, marginBottom:13, paddingLeft:12,
          borderLeft:`2px solid ${T.isDark?'rgba(201,107,154,0.4)':T.rose.d+'55'}`, fontStyle:'italic', position:'relative' }}>
          {order.items}
        </div>
